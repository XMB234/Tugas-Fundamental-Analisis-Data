...
def load_data():
    ...
    master_orders_df = pd.read_csv('master_orders.csv')
    monthly_revenue_df = pd.read_csv('monthly_revenue.csv')
    orders_monthly_df = pd.read_csv('orders_monthly.csv')
    category_review_scores_df = pd.read_csv('category_review_scores.csv')
    state_review_summary_df = pd.read_csv('state_review_summary.csv')
    high_value_product_preferences_df = pd.read_csv('high_value_product_preferences.csv', index_col=0)
    customer_value_df = pd.read_csv('customer_value.csv')
    payment_customer_df = pd.read_csv('payment_customer.csv')
    items_products_df = pd.read_csv('items_products.csv') # Baru: Muat items_products
    ...
    rfm_segmentation_df = pd.read_csv('rfm_segmentation.csv')
